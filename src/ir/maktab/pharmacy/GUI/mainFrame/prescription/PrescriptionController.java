	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == jf.getAddbtn()) {
			...
			try {
				...
				jf.addDrug(jf.getNameTf().getText(), jf.prescriptionID, Integer.parseInt(jf.getCountTf().getText()), 0);
				}else {
					jf.addDrug(jf.getNameTf().getText(), jf.prescriptionID, Integer.parseInt(jf.getCountTf().getText()), Double.parseDouble(jf.getPaymenntTf().getText()));
				}
