...
public class panel2 extends JPanel {
	...
	public panel2() {
		...
		JLabel lblInsureCode = new JLabel("Insurance Code");
	...
	public void getInsurance(String name) {

		DefaultTableModel tableModel = (DefaultTableModel) table.getModel();
		String column[] = { "ID", "NAME", "INSURANCE CODE" };
		tableModel.setDataVector(findInsurance(name), column);
		table.setModel(tableModel);

	}

	public String[][] findInsurance(String name) {

		InsuranceDAOImp insuDAO = new InsuranceDAOImp();
		ArrayList<Insurance> insuList = new ArrayList<>();
		insuList.add(insuDAO.getInsuranceByName(name));
		String[][] list = new String[insuList.size()][5];
